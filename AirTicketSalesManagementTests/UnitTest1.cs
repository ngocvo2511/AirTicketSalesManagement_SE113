...
namespace AirTicketSalesManagement.Tests.ViewModel.Admin
{
    [TestFixture]
    public class FlightManagementViewModelTests
    {
        ...
        public void SetUp()
        {
            ...
            {
                new Sanbay { MaSb = "SGN", ThanhPho = "HCM", QuocGia = "VN" },
                new Sanbay { MaSb = "HAN", ThanhPho = "HN", QuocGia = "VN" }
            }.AsQueryable();
